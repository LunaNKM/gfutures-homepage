...
export const whatWeDo = [
  ...
  {
    title: "Stragegy",
    desc: "데이터와 현지 인사이트 기반의 글로벌 진출 전략을 설계합니다.",
  },
  {
    title: "Marketing",
...
export const services = [
  ...
  },
  {
    ...
    ko: "인플루언서 전략 제안",
    desc: "브랜드 이미지, 프로모션 목적, 활용 계획 등에 따라 매체·티어 구분 없는 최적화된 인플루언서 전략을 제안 드립니다. 또한 일본 셀럽 PR, 앰버서더 계약, 전용 광고 상품까지 지원합니다.",
  },
  {
  ...
  },
  {
    slug: "more",
    en: "& More",
    ko: "일본 현지 네트워킹 기반 전략 수립",
    desc: "일본 현지 강력한 네트워킹을 바탕으로 고객의 목표 달성에 필요한 전 과정을 함께 합니다.",
  },
];
